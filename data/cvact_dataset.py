...
class CVACTDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        "Exclude ground image areas with large panoramic distortions"
        ...
        G_img = G_img.crop((left, top, right, bottom))

        A_transform = transforms.Compose([transforms.Resize([256,256]),
                                         transforms.ToTensor(),
